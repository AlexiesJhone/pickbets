                ...
                <div class="nav-tabs-navigation">
                  <div class="nav-tabs-wrapper">
                    <ul class="nav nav-tabs" data-tabs="tabs">
                      ...
                      <li class="nav-item" >
                        <a class="nav-link text-success" @click.prevent="showaddgroup">
                    ...
                    <table class="table table-sm">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><input type="text" name="" value="" placeholder="Location" class="form-control" v-model="form.location"></td>
                          <td> <input type="text" name="" value="" class="form-control" v-model="form.description"> </td>
                        </tr>
                        <tr>
                          <td colspan="4"> <button type="button" name="button" class="btn btn-success btn-sm col-md-12" @click.prevent='getallgroup'>Search</button>
                    ...
                    <table class="table table-sm">
                      ...
                      <tbody>
                        <tr v-for="t in groups.data">
                          ...
                          <td class="text-success font-weight-bold"> <a class="text-success font-weight-bold" v-if="t.active===1">Active</a><a class="text-success font-weight-bold" v-else>Deactivated</a> </td>
                          <td>{{t.created_at|datef}}</td>
                          <td> <a class="btn btn-info btn-sm text-white" @click.prevent='editgroup(t)'>Edit</a> <a class="btn btn-success btn-sm text-white" @click.prevent='showusers(t)'>View Users</a> </td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table class="table table-hover table-stripped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            :options="[{ role: 'Admin', id: 1 },{ role: 'teller', id: 0 },{ role: 'Mobile Player', id: 3 },{ role: 'Cashier', id: 4 },{ role: 'Declarator', id: 5 },{ role: 'CSR', id: 6 },
                            { role: 'Boss/Manager', id: 7 },]"
                          ...
                          <td>
                            ...
                            :options="[{ role: 'Active', id: 1 },{ role: 'Deactivated', id: 0 },]"
                      ...
                      <tbody>
                        <tr v-for="t in groupusers.data">
                          <td>{{t.name}}</td>
                          <td>{{t.username}}</td>
                          <td><a v-if="t.role===3">Mobile</a><a v-if="t.role===0">Teller</a> <a v-if="t.role===7">Boss</a> <a v-if="t.role===6">CSR</a><a v-if="t.role===4">Cashier</a>
                            <a v-if="t.role===5">Declarator</a><a v-if="t.role===1">Admin</a>   </td>
                          <td><a v-if="t.active===1" class="text-success">Active</a> <a href="#" v-else>Deactivated</a> </td>
                        </tr>
                        <tr>
                          <th colspan="4">
...
<script>
    export default {
        ...
        methods:{
          ...
          getallgroup(page = 1){
            this.loading=false;
            this.form.post('/pick20/getallgroups?page='+page).then(response=>{
              this.loading=false;
