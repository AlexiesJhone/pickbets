          ...
          <div id="overlay" v-if="loading">
            ...
            <div class="col-md-12">
              <div class="card">
                  ...
                  <table class="table table-sm">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><v-select v-model='search.type'  class="col-sm-12" :options="items" placeholder="Choose Admin" :reduce="type => type.type" id="user" label="type" :select-on-key-codes="[188, 13]" selectOnTab :clearable="false"/></center></td>
                ...
                <div class="card-footer">
                  <a class="btn btn-warning btn-sm col-md-12 text-white" @click.prevent='clearsearch'>Clear Search</a>
                </div>
              </div>
              <div class="card">
              <div class="card-header card-header-tabs card-header-dark bg-dark">
