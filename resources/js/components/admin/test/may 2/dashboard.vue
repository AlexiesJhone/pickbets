                ...
                <div class="row">
                  ...
                  <div class="card"  v-if="show">
                    <div class="card-header-dark bg-dark text-white">
                      <b>Event Name :</b> <b class="text-warning"><b>{{form.event_name}} <b class="text-white">[Pick : {{control.pick}} | {{form.fights}} Fights]</b></b></b><a class="float-right text-white" @click.prevent='back'><i class="fa fa-undo text-danger" aria-hidden="true"></i> Back to Events</a>
                    </div>
                        ...
                        <table class="table noborder" style="">
                          ...
                          <tbody>
                            <tr v-for='(r,index) in resultx' class="">
                              ...
                              <td class="noborder"> <a @click.prevent='showregrade(r)' v-if="r.fightnumber==resultx[0].fightnumber" class="btn btn-danger btn-sm text-white">Regrade</a> <a class="btn btn-danger btn-sm disabled" v-else disabled>Regrade</a> </td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content"  style="border:none !important;">
                        ...
                        <div class="modal-body">
                          ...
                          <input type="number" class="form-control" oninput="this.value = Math.round(this.value);" name="" v-model="eventx.startingfight">
                          ...
                          <input type="number" class="form-control" name="" oninput="this.value = Math.round(this.value);" v-model="eventx.fights">
                  ...
                  <div class="modal fade" id="winnerscount" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content" style="border:none !important;">
                        <div class="modal-header bg-dark text-warning">
                          <h5 class="modal-title modal-title font-weight-bold" id="exampleModalLongTitle">Winners Count</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
