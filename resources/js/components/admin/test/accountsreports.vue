                  ...
                  <div class="modal-content modal-content1" style="border:none">
                    ...
                    <div class="modal-body modal-body1 justify-content-center table-responsive" style="padding:0">
                      <table class="table table-hover table-stripped table-bordered">
                        ...
                        <tbody>
                          <tr>
                            <td colspan="2"><a class="text-success" v-if="bets.length>0">{{bets.length}}</a> <a v-else class="text-danger">{{bets.length}}</a> </td>
                      ...
                      <table class="table table-hover table-stripped table-bordered">
                        ...
                        <tbody>
                          <tr v-for="t in arenareportsmodaltotal">
                            <td >{{t.numberofbets}}</td>
                            <td>{{Number(t.totalbetsamountfinal).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</td>
                            <td colspan="2">{{Number(t.rakefinal).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</td>
                            <td>{{Number(t.totalpayout).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</td>
                            <td colspan="2">{{Number(t.totalpayoutunclaimed).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</td>
                          </tr>
                        </tbody>
                        <thead>
                          <tr class="bg-dark text-warning ">
                  ...
                  <div class="modal-content modal-content1" style="border:none">
                    ...
                    <div class="modal-body modal-body1 table-responsive" style="padding:0">
                      <table class="table table-hover table-stripped table-bordered">
                        ...
                        <thead>
                          <tr class="">
                            <th colspan="3" class="font-weight-bold">Total Income</th>
                            <th colspan="3" class="font-weight-bold">Total Bet Amount</th>
                            <th colspan="3" class="font-weight-bold">Total Payout</th>
                            <th colspan="3" class="font-weight-bold">Total Unclaimed</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr v-for="t in totalarenareports">
                            <td colspan="3">{{Number(t.totalincome).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</td>
                            <td colspan="3">{{Number(t.totalamount).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</td>
                            <td colspan="3">{{Number(t.totalpayout).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</td>
                            <td colspan="3">{{Number(t.totalunclaimed).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</td>
                          </tr>
                        </tbody>
                        <thead>
                          <tr class="bg-dark text-warning">
...
<script>
    export default {
      ...
      methods:{
        ...
        geteventsreports(){
          this.loading=true;
          axios.get('/pick20/geteventsreports').then(response=>{
            this.loading=false;
