                    ...
                    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                      <div class="modal-content"  style="border:none !important;">
                        ...
                        <div class="modal-body" style=" border:none !important;">
                          <center>Please choose result for fightnumber: <br> <b>{{results.fightnumberregrade}}</b><br> Current result : <b>{{results.result}}</b>
                            <label for="user">Select admin to confirm</label>
                          ...
                          <div class="container-fluid">
                            <div class="row">
                              <div class="col" v-if="results.result!='Wala'">
                                <button  class="btn btn-info text-white col-md-12" :disabled='isDisabledr'  @click.prevent='confirmgradew(results)'>Wala</button >
                                </div>
                              <div class="w-100"></div>
                              <div class="col" v-if="results.result!='Meron'">
                                <button  class="btn btn-danger text-white col-md-12" :disabled='isDisabledr' @click.prevent='confirmgradem(results)'>Meron</button ></div>
                                <div class="w-100"></div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content"  style="border:none !important;">
                        ...
                        <div class="modal-body">
                          ...
                          <label for="">Starting Fight Number</label>
                          <input type="number" class="form-control" v-if="modalevent==='edit'" oninput="this.value = Math.round(this.value);" name="" v-model="eventx.startingfight" disabled>
                          <input type="number" class="form-control" v-if="modalevent==='add'" oninput="this.value = Math.round(this.value);" name="" v-model="eventx.startingfight">
                          ...
                          <input type="number" class="form-control" v-if="modalevent==='add'" name="" oninput="this.value = Math.round(this.value);" v-model="eventx.fights">
