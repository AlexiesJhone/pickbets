                    ...
                    <tbody>
                      <tr v-for="t in events.data">
                        ...
                        <td>
                          ...
                          <a class="btn btn-sm btn-info text-white" @click.prevent='arenareportsmodal2(t)' v-if="t.pick2">Arena Reports of Pick 2</a>
                          <a class="btn btn-sm btn-info text-white" @click.prevent='arenareportsmodalpick3(t)' v-if="t.pick3">Arena Reports of Pick 3</a>
                          <a class="btn btn-sm btn-info text-white" @click.prevent='arenareportsmodalpick4(t)' v-if="t.pick4">Arena Reports of Pick 4</a>
                          <a class="btn btn-sm btn-info text-white" @click.prevent='arenareportsmodalpick5(t)' v-if="t.pick5">Arena Reports of Pick 5</a>
                          <a class="btn btn-sm btn-info text-white" @click.prevent='arenareportsmodalpick6(t)' v-if="t.pick6">Arena Reports of Pick 6</a>
                          <a class="btn btn-sm btn-info text-white" @click.prevent='arenareportsmodalpick8(t)' v-if="t.pick8">Arena Reports of Pick 8</a>
                          <a class="btn btn-sm btn-info text-white" @click.prevent='arenareportsmodalpick14(t)' v-if="t.pick14">Arena Reports of Pick 14</a>
                      ...
                      <table class="table table-hover table-stripped table-bordered">
                        ...
                        <tbody>
                          <tr v-for="t in bets.data">
                            ...
                            <td>{{t.startingfight}} - Pick {{t.pick}} </td>
                            <td>{{t.bet}}</td>
                            ...
                            <td>
                              ...
                              <a v-if="t.turn==20">{{Number(t.income).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a>
                              <a v-else>{{Number(t.income).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a>
                            </td>
                      ...
                      <table class="table table-hover table-stripped table-bordered">
                        ...
                        <tbody>
                          <tr v-for="t in arenareports">
                            <!-- alexmuna -->
                            <td class="font-weight-bold">{{t.startingfight}} - Pick {{t.pick}}</td>
                            <td >{{t.results}}</td>
                            <td>{{t.winners}}</td>
                            <td>{{t.bet}}</td>
                      ...
                      <table class="table table-hover table-stripped table-bordered">
                        ...
                        <tbody>
                          <tr v-for="t in betsarenareports.data">
                            ...
                            <td> <p v-if="t.claimed===1">Claimed</p><p v-else-if="t.claimed===null&&t.winner===1||t.winner===2||t.winner===4">Not Claimed</p> <p v-if="t.winner===3||t.winner===0||t.winner===5">-</p></td>
                            <td>{{t.wins}}</td>
                            <td>{{t.created_at|datef}}</td>
                ...
                <table class="table tabl-sm table-striped table-borderless table-hover">
                  ...
                  <tbody>
                    ...
                    <!-- <tr v-for="(t,index) in bets.slice().reverse()" :index='index'> -->
                      ...
                      <td style="padding: 0.20rem"><b v-if="betx.selection==='Meron'" class="text-danger">Red Apple</b><b v-if="betx.selection==='Wala'" class="text-info">White Apple</b>
              ...
              <div class="modal-content modal-content1">
                ...
                <div class="modal-body modal-body1 table-responsive" style="padding:0">
                  <table class="table">
                    <thead>
                      <tr>
                        <th colspan="22"><b>Event Name :</b> {{form.event_name}}</th>
                      </tr>
                      <tr>
                        <th colspan="22"><b>Arena :</b> {{form.venue}}</th>
                      </tr>
                      <tr>
                        <th colspan="22"><b>Created Date :</b> {{form.created_at|datef}}</th>
                      </tr>
                      <tr>
                        <th colspan="22"><b>Date Open :</b> {{form.fightopened|datef}}</th>
                      </tr>
                      <tr>
                        <th colspan="22"><b>Date Closed :</b> <a v-if="form.fightclosed">{{form.fightclosed|datef}}</a><a v-else> - </a> </th>
                      </tr>
                    </thead>
                    <thead>
                      <tr>
                        <th colspan="22" class="bg-dark text-warning text-center font-weight-bold">List of Groups</th>
                      </tr>
                      <tr>
                        <th colspan="22">
                      ...
                      <tr>
                        ...
                        <th class="font-weight-bold">Pick 3 Bets</th>
                        <th class="font-weight-bold">Pick 3 Rake</th>
                        <th class="font-weight-bold">Pick 4 Bets</th>
                        <th class="font-weight-bold">Pick 4 Rake</th>
                        <th class="font-weight-bold">Pick 5 Bets</th>
                        <th class="font-weight-bold">Pick 5 Rake</th>
                        <th class="font-weight-bold">Pick 6 Bets</th>
                        <th class="font-weight-bold">Pick 6 Rake</th>
                        <th class="font-weight-bold">Pick 8 Bets</th>
                        <th class="font-weight-bold">Pick 8 Rake</th>
                        <th class="font-weight-bold">Pick 14 Bets</th>
                        <th class="font-weight-bold">Pick 14 Rake</th>
                    ...
                    <tbody>
                      <tr v-for="t in groups.data" >
                        ...
                        <td><a v-if="t.totalpick3">{{Number(t.totalpick3).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalrakepick3">{{Number(t.totalrakepick3).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalpick4">{{Number(t.totalpick4).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalrakepick4">{{Number(t.totalrakepick4).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalpick5">{{Number(t.totalpick5).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalrakepick5">{{Number(t.totalrakepick5).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalpick6">{{Number(t.totalpick6).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalrakepick6">{{Number(t.totalrakepick6).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalpick8">{{Number(t.totalpick8).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalrakepick8">{{Number(t.totalrakepick8).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalpick14">{{Number(t.totalpick14).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
                        <td><a v-if="t.totalrakepick14">{{Number(t.totalrakepick14).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a></td>
              ...
              <div class="modal-content modal-content1">
                ...
                <div class="modal-body modal-body1 table-responsive" style="padding:0">
                  <table class="table">
                    ...
                    <thead>
                      <tr>
                        <th colspan="22" class="bg-dark text-warning text-center font-weight-bold">List of Users</th>
                      </tr>
                      <tr>
                        <th class="font-weight-bold">ID</th>
                        <th class="font-weight-bold">Teller/Mobile</th>
                    ...
                    <tbody>
                      <tr v-for="t in groupsuser" >
                        ...
                        <td><a v-if="t.totalpick3||t.role==9"><a v-if="t.totalpick3">{{Number(t.totalpick3).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalrakepick3||t.role==9"><a v-if="t.totalrakepick3">{{Number(t.totalrakepick3).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalpick4||t.role==9"><a v-if="t.totalpick4">{{Number(t.totalpick4).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalrakepick4||t.role==9"><a v-if="t.totalrakepick4">{{Number(t.totalrakepick4).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalpick5||t.role==9"><a v-if="t.totalpick5">{{Number(t.totalpick5).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalrakepick5||t.role==9"><a v-if="t.totalrakepick5">{{Number(t.totalrakepick5).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalpick6||t.role==9"><a v-if="t.totalpick6">{{Number(t.totalpick6).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalrakepick6||t.role==9"><a v-if="t.totalrakepick6">{{Number(t.totalrakepick6).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalpick8||t.role==9"><a v-if="t.totalpick8">{{Number(t.totalpick8).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalrakepick8||t.role==9"><a v-if="t.totalrakepick8">{{Number(t.totalrakepick8).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalpick14||t.role==9"><a v-if="t.totalpick14">{{Number(t.totalpick14).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                        <td><a v-if="t.totalrakepick14||t.role==9"><a v-if="t.totalrakepick14">{{Number(t.totalrakepick14).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a> <a v-else>0</a> </a><a v-else>n/a</a></td>
                  ...
                  <table class="table table-hover table-stripped table-bordered">
                    ...
                    <tbody v-for="t in transactions.data">
                      <tr v-for="s in t.transactions" class="">
                        <td>{{s.id}}</td>
                        <td >{{s.type}}</td>
                        <td> <a v-if="s.type==='Cash Out'||s.type==='Cash In'||s.type==='Deposit'||s.type==='Withdrawal_Mobile'">-</a><a v-else>{{s.barcode}}</a></td>
                        <td>{{s.user.name}}</td>
      ...
      data(){
        return{
          ...
          transfields: {
             ...
             'Pick 3 Bets': 'totalpick3',
             'Pick 3 Rake': 'totalrakepick3',
             'Pick 4 Bets': 'totalpick4',
             'Pick 4 Rake': 'totalrakepick4',
             'Pick 5 Bets': 'totalpick5',
             'Pick 5 Rake': 'totalrakepick5',
             'Pick 6 Bets': 'totalpick6',
             'Pick 6 Rake': 'totalrakepick6',
             'Pick 8 Bets': 'totalpick8',
             'Pick 8 Rake': 'totalrakepick8',
             'Pick 14 Bets': 'totalpick14',
             'Pick 14 Rake': 'totalrakepick14',
      ...
      methods:{
        ...
        arenareportsmodalpick3(t){
          ...
          this.dataForExcel[6].j = 0;
            ...
            this.dataForExcel[6].c = 0;
          this.pick = 2;
          this.titleheader = 'Arena Reports of Pick 3';
            this.bets=[];
            this.loading=true;
            this.form.fill(t);
          this.form.post('/pick20/arenareportsmodalpick3').then(response=>{
            this.loading=false;
            this.arenareports = response.data;
          this.form.fill(t);
          this.form.post('/pick20/arenareportsmodaltotalpick3').then(response=>{
            this.arenareportsmodaltotal=response.data;
            $('#arenareportsmodal').modal('show');
            if (this.form.event_name) {
              this.dataForExcel[0].b = this.form.event_name;
        ...
        arenareportsmodalpick4(t){
          ...
          this.dataForExcel[6].j = 0;
            ...
            this.dataForExcel[6].c = 0;
          this.pick = 2;
          this.titleheader = 'Arena Reports of Pick 4';
            this.bets=[];
            this.loading=true;
            this.form.fill(t);
          this.form.post('/pick20/arenareportsmodalpick4').then(response=>{
            this.loading=false;
            this.arenareports = response.data;
          this.form.fill(t);
          this.form.post('/pick20/arenareportsmodaltotalpick4').then(response=>{
            this.arenareportsmodaltotal=response.data;
            $('#arenareportsmodal').modal('show');
            if (this.form.event_name) {
              this.dataForExcel[0].b = this.form.event_name;
        ...
        arenareportsmodalpick5(t){
          ...
          this.dataForExcel[6].j = 0;
            ...
            this.dataForExcel[6].c = 0;
          this.pick = 2;
          this.titleheader = 'Arena Reports of Pick 5';
            this.bets=[];
            this.loading=true;
            this.form.fill(t);
          this.form.post('/pick20/arenareportsmodalpick5').then(response=>{
            this.loading=false;
            this.arenareports = response.data;
          this.form.fill(t);
          this.form.post('/pick20/arenareportsmodaltotalpick5').then(response=>{
            this.arenareportsmodaltotal=response.data;
            $('#arenareportsmodal').modal('show');
            if (this.form.event_name) {
              this.dataForExcel[0].b = this.form.event_name;
        ...
        arenareportsmodalpick6(t){
          ...
          this.dataForExcel[6].j = 0;
            ...
            this.dataForExcel[6].c = 0;
          this.pick = 2;
          this.titleheader = 'Arena Reports of Pick 6';
            this.bets=[];
            this.loading=true;
            this.form.fill(t);
          this.form.post('/pick20/arenareportsmodalpick6').then(response=>{
            this.loading=false;
            this.arenareports = response.data;
          this.form.fill(t);
          this.form.post('/pick20/arenareportsmodaltotalpick6').then(response=>{
            this.arenareportsmodaltotal=response.data;
            $('#arenareportsmodal').modal('show');
            if (this.form.event_name) {
              this.dataForExcel[0].b = this.form.event_name;
        ...
        arenareportsmodalpick8(t){
          ...
          this.dataForExcel[6].j = 0;
            ...
            this.dataForExcel[6].c = 0;
          this.pick = 2;
          this.titleheader = 'Arena Reports of Pick 8';
            this.bets=[];
            this.loading=true;
            this.form.fill(t);
          this.form.post('/pick20/arenareportsmodalpick8').then(response=>{
            this.loading=false;
            this.arenareports = response.data;
          this.form.fill(t);
          this.form.post('/pick20/arenareportsmodaltotalpick8').then(response=>{
            this.arenareportsmodaltotal=response.data;
            $('#arenareportsmodal').modal('show');
            if (this.form.event_name) {
              this.dataForExcel[0].b = this.form.event_name;
        ...
        arenareportsmodalpick14(t){
          ...
          this.dataForExcel[6].j = 0;
            ...
            this.dataForExcel[6].c = 0;
          this.pick = 2;
          this.titleheader = 'Arena Reports of Pick 14';
            this.bets=[];
            this.loading=true;
            this.form.fill(t);
          this.form.post('/pick20/arenareportsmodalpick14').then(response=>{
            this.loading=false;
            this.arenareports = response.data;
          this.form.fill(t);
          this.form.post('/pick20/arenareportsmodaltotalpick14').then(response=>{
            this.arenareportsmodaltotal=response.data;
            $('#arenareportsmodal').modal('show');
            if (this.form.event_name) {
              this.dataForExcel[0].b = this.form.event_name;
