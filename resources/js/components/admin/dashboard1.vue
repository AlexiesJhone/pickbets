                ...
                <div class="row">
                  ...
                  <div class="card"  v-if="show">
                    <div class="card-header-dark bg-dark text-white">
                      <b>Event Name :</b> <b class="text-warning"><b>{{events.event_name}} <b class="text-white">[Pick : {{events.pick}} | {{events.fights}} Fights]</b></b></b><a class="float-right text-white" @click.prevet='back'><i class="fa fa-undo text-danger" aria-hidden="true"></i> Back to Events</a>
                    </div>
                    <div class="card-body" style="">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <a @click.prevent='meron' class="btn btn-danger col-md-12 text-white"><b>MERON</b></a>
                        </div><br><br>
                        <div class="col-md-6">
                          <a @click.prevent='wala' class="btn btn-info col-md-12 text-white"><b>WALA</b></a>
                        </div><br><br>
                        <div class="col-md-6">
                          <a @click.prevent='draw' class="btn btn-success col-md-12 text-white"><b>DRAW</b></a>
                        </div><br><br>
                        <div class="col-md-6">
                          <a @click.prevent='cancel' class="btn btn-default col-md-12 text-white"><b>CANCEL</b></a>
                        </div>
                      </div>
                        </div>
                        ...
                        <table class="table noborder" style="">
                          ...
                          <tbody>
                            <tr v-for='(r,index) in resultx' class="">
                              ...
                              <td class="noborder">
                                <p :disabled='resultbutton' v-if="r.result==='Meron'" class="text-danger font-weight-bold text-uppercase">{{r.result}}</p>
                                <p :disabled='resultbutton' v-if="r.result==='Wala'" class="text-info font-weight-bold text-uppercase">{{r.result}}</p>
                                <p :disabled='resultbutton' v-if="r.result==='Draw'" class="text-success font-weight-bold text-uppercase">{{r.result}}</p>
                                <p :disabled='resultbutton' v-if="r.result==='Cancelled'" class="text-white font-weight-bold text-uppercase">{{r.result}}</p>
                              </td>
