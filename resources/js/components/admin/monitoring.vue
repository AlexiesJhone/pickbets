                      ...
                      <table class="table table-hover table-stripped table-bordered">
                        ...
                        <tbody>
                          <tr v-for="t in users">
                            ...
                            <td> <a class="btn btn-sm btn-success text-white" @click.prevent='viewreport(t)'>View Report</a><a class="btn btn-sm btn-danger text-white" v-if="t.cash>0&&user.role==1&&t.active==1" @click.prevent='forcecashout(t)'>Force Cash Out</a><a class="btn btn-sm btn-danger text-white disabled" v-else>Force Cash Out</a></td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      <table class="table table-hover table-stripped table-bordered">
                        ...
                        <tbody v-for="t in transactions.data">
                          <tr v-for="s in t.bets">
                            ...
                            <td>{{Number(s.amount).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</td>
                            <td><a v-if="s.winner===0" class="text-danger font-weight-bold">Pending</a> <a v-else-if="s.winner === 3||s.winner === 5" class="text-danger font-weight-bold">Loss -{{Number(s.amount).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</a>
