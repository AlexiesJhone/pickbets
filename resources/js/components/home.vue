        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-5">
            ...
            <div class="card" v-if="select" style="background-color: transparent;">
              ...
              <div class="card-header bg-dark text-white">
                <center>
                <b class="text-warning">PICK {{events.pick}} - {{events.event_name}} [{{events.fights}} Fights]</b>
                <hr style="margin-top:0.5rem;margin-bottom:0.5rem">

                <cash v-if="refreshmoney" :user="user"></cash><b class="text-muted" v-if="odds>=10000">Total Payouts : <b class="text-success">{{odds.toLocaleString()}}</b></b> </center>
              </div>
              <div class="card-body" style="padding: 0.25rem;padding-top:0; background-color: white"><center>
                ...
                <p class="h6">Bet Amount[per single bet] : <b class="text-success">{{Number(fight.amount).toLocaleString()}}</b></p>
              </center>
                ...
                <div class="card" id='printMe' v-show="awd">
                  ...
                  <p>Amount : {{Number(events.amount).toLocaleString('en-PH', {style:'currency', currency:'PHP'})}}</p>
                  ...
                  <div class="card-body table-responsive-sm" style="max-height:60vh; overflow:auto; padding:0;">
                    <table class="table table-sm  table-striped table-borderless table-hover">
                      ...
                      <tbody class="" style="width:100%">
                        <tr v-for='(bet,index) in selected' :index="index">
                          <td class="text-center"><b>{{bet.fightnumber}}</b></td>
                          <td class="">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" :id="index+1" v-on:change="pickm1(index)" v-model='bet.selection.meron'>
                          ...
                          <td class="">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="defaultCheck2"  v-on:change="pickw1(index)" v-model="bet.selection.wala">
                              ...
                              <label class="form-check-label font-weight-bold" v-if="!bet.selection.wala">
                          ...
                          <td class="">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="defaultCheck1" v-on:change="pickd1(index)" v-model="bet.selection.draw">
                              ...
                              <label class="form-check-label font-weight-bold" v-if="!bet.selection.draw">
                  ...
                  <table class="table tabl-sm table-striped table-borderless table-hover">
                    ...
                    <tbody>
                      ...
                      <!-- <tr v-for="(t,index) in bets.slice().reverse()" :index='index'> -->
                        ...
                        <td v-if="events.pick===20 "><b>{{t.selection[0].fightnumber}}</b> to <b>{{t.selection[19].fightnumber}}</b></td>
                        <td v-if="events.pick===15 "><b>{{t.selection[0].fightnumber}}</b> to <b>{{t.selection[14].fightnumber}}</b></td>
                        <td v-if="events.pick===24 "><b>{{t.selection[0].fightnumber}}</b> to <b>{{t.selection[23].fightnumber}}</b></td>
    ...
    export default {
      ...
      methods:{
        ...
        created() {
          ...
          this.getevents();
          this.Getallstartingfights();
	  Echo.private('announcement')
          .listen('announce',(event)=>{
            this.getcontrol();
          });
          ...
          .listen('eventlistener',(event)=>{
            ...
            if (event.events.control==='Last Call' && this.events.id===event.events.event_id && this.select===event.events.startingfight ) {
              ...
              else if (event.events.control==="Open" && this.events.id===event.events.event_id && this.select===event.events.startingfight ){
                this.control='Open';
                // this.getevents();
              }else if(event.events.control==='Closed' && this.events.id===event.events.event_id && this.select===event.events.startingfight ) {
                // this.control='Close';
