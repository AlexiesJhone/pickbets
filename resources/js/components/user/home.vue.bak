<template>
    <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-md-5">
              ...
              <table class="table table-sm table-striped" v-if="!select&&startings.length">
                ...
                <tbody>
                  ...
                  <!-- <tr v-for="t in startings" v-if="t.control==='Open'||t.control==='Last Call'"> -->
                    ...
                    <td>
                      <a class="btn btn-outline-dark btn-sm" @click.prevent='placebet(t)' v-if="t.control==='Open'||t.control==='Last Call'"><i class="fa fa-arrow-left" aria-hidden="true"></i> Play Pick <b>{{t.pick}}</b> </a>
                      <a class="btn btn-outline-dark btn-sm disabled" v-if="t.control==='Closed'"><i class="fa fa-arrow-left" aria-hidden="true"></i> Play Pick <b>{{t.pick}}</b> </a>
                     </td>
                  </tr>
            ...
            <div class="card" v-if="select" style="background-color: transparent;">
              ...
              <div class="card-body" style="padding: 0.25rem;padding-top:0; background-color: white"><center>
                ...
                <p class="h6" v-if="fight.pick==2 && !rebet">  Choose Bet Amount :
                ...
                <div class="form-group">
                  ...
                  <center>
                  <div class="form-check"  v-if="fight.pick!=2">
                    ...
                    <table class="table table-sm  table-striped table-borderless table-hover">
                      <thead class="thead-dark">
                        <tr>
                          ...
                          <th class="text-center text-danger">Meron</th>
                          <th class="text-center text-info">Wala</th>
                          <th class="text-center text-success">Draw</th>
                        </tr>
                      </thead>
                          ...
                          <td class="">
                            <div class="form-check">
                              ...
                              <label class="form-check-label text-danger font-weight-bold" v-if="bet.selection.meron">
                                ...
                                <a class="btn btn-sm btn-danger" :for="index+1" @click.prevent='picksm1(index)'>Meron</a>
                              </label>
                              <label class="form-check-label font-weight-bold" v-if="!bet.selection.meron" :for="m+index" >
                                ...
                                <a class="btn btn-sm" :for="index+1" @click.prevent='picksm1(index)'>Meron</a>
                              </label>
                            </div>
                          </td>
                          <td class="">
                            <div class="form-check">
                              ...
                              <label class="form-check-label text-info font-weight-bold" v-if="bet.selection.wala">
                                <!-- <a class="btn btn-sm btn-info text-white" @click.prevent='picksw1(index)'>
                                 ...
                                 <a class="btn btn-sm btn-info text-white" :for="index+1" @click.prevent='picksw1(index)'>Wala</a>
                              </label>
                              <label class="form-check-label font-weight-bold" v-if="!bet.selection.wala" :for="w+index">
                                ...
                                <a class="btn btn-sm" :for="index+1" @click.prevent='picksw1(index)'>Wala</a>
                              </label>
                            </div>
                          </td>
                          <td class="">
	     ...
	     <button class="btn btn-primary form-control" @click.prevent='randommultiple()' v-if='selected.length&&fight.pick!=2' style="">Place Multiple Random Picks</button>
            ...
            <button type="button" class="btn btn-secondary form-control" name="button" @click.prevent='viewpendingbets'>View Current Pending Bets</button><br><br>
            <button type="button" class="btn btn-secondary form-control" name="button" @click.prevent='viewentrynames'>View Current Entrynames</button>
                              ...
                              <table class="table table-sm table-striped" >
                                ...
                                <tbody>
                                  <tr v-for="(a,indexx) in t.expertbet" :index='indexx'>
                                    ...
                                    <td class="text-center">{{a.bet}}<br v-if="user.role===0"><a class="btn btn-success btn-sm" @click.prevent='reprint(a)' v-if="user.role===0">Reprint</a></td>
    ...
    export default {
      ...
      methods:{
        ...
        showconfirmrandompicks(){
          ...
          if (this.fight.amount <= parseInt(this.users.cash.slice(0,-4)) && this.fight.amount>=100 || this.users.role===0) {
        ...
        showconfirm(){
          ...
          if (this.totalamount) {
            ...
            this.disabled=false;
            if (this.totalamount<=parseInt(this.users.cash.slice(0,-4)) || this.users.role===0) {
              $('#confirmation2').modal('show');
            }else {
              Swal.fire(
                'Not enough balance',
        ...
        insert2(){
          ...
          .then(()=>{
            ...
            if (this.user.role===3) {
              Swal.fire(
                'error',
                'Please make sure that all fightnumbers has a bet and please make sure your bet has no more than 2 draw',
                'error'
              )
            }else {
              Swal.fire(
        ...
        created() {
          ...
          Toast.fire({
                  icon: 'info',
                  html: '<center>Jackpot for pick20 is <br> <b>8 MILLION</b> <br>You can check results/winners on the leaderboards tab.</center>',
                  showCloseButton: true,
                });
                this.valid();
