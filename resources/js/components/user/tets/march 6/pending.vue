        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
              ...
              <div id="overlay" v-if="loading">
                ...
                <div class="card">
                    <div class="card-header bg-dark text-white">Pending Bets<br> <a class="text-warning">{{events.event_name}} - Starting Fight {{events.startingfight}}</a> </div>
                        ...
                        <table class="table tabl-sm table-striped table-borderless table-hover">
                          ...
                          <tbody>
                            ...
                            <!-- <tr v-for="(t,index) in bets.slice().reverse()" :index='index'> -->
                              ...
                              <td style="padding: 0.20rem"><b v-if="t.selection==='Meron'" class="text-danger">{{t.selection}}</b><b v-if="t.selection==='Wala'" class="text-info">{{t.selection}}</b>
