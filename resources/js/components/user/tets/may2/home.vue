        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-5">
            ...
            <div class="card table-responsive-sm" v-if="events">
              ...
              <table class="table table-sm table-striped" v-if="!select&&startings.length">
                <thead class="thead-dark ">
                  <tr>
                    <th colspan="3" class="" style="text-align: center;" ><b class="text-warning">All available starting fights </b>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body" id='printMe'>
                    <div class="card" v-for="t in receipt">
                      ...
                      <b>Bet Range : </b>{{t.startingfight}} - {{t.endingfight}}<br>
                      <b>Additional fight : </b> {{t.cancelled-2}} - {{t.cancelled}}<br>
            ...
            <div class="card" v-if="select" style="background-color: transparent;">
              ...
              <div class="card-header bg-dark text-white">
                <center>
                <b class="text-warning">PICK {{controls.pick}} - {{actualevent.event_name}} [{{actualevent.fights}} Fights]</b>
                <hr style="margin-top:0.5rem;margin-bottom:0.5rem">

                <cash v-if="refreshmoney" :user="user"></cash><b class="text-muted" v-if="odds>=10000">Total Payout : <b class="text-success">{{odds.toLocaleString()}}</b></b> </center>
              </div>
	     ...
	     <button class="btn btn-primary form-control" @click.prevent='randommultiple()' v-if='selected.length' style="">Place Multiple Random Picks</button>
...
<script>
    export default {
	  ...
	  this.getuser();
          ...
          Toast.fire({
                  icon: 'info',
                  title: 'Jackpot for pick20 is 100,000<br>You can check results/winners on the leaderboards tab.',
                  showCloseButton: true,
                });
                this.valid();
