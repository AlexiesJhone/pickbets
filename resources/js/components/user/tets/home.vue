    ...
    <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-md-5">
            ...
            <userwithdrawal :userx='user'></userwithdrawal>
            ...
            <div class="card" v-if="control==='Open' || control==='Last'">
              ...
              <div class="card-header bg-dark text-white">
                <b class="text-warning">PICK {{events.pick}}</b> - {{events.event_name}} <hr style="margin-top:0.5rem;margin-bottom:0.5rem">
                    ...
                    <table class="table table-sm  table-striped table-borderless table-hover">
                      ...
                      <tbody class="" style="width:100%">
                        <tr v-for='(bet,index) in selected' :index="bet.id">
                          ...
                          <td class="text-center"><b class="btn btn-danger btn-sm" v-if='bet.selection==="Meron"'>{{bet.selection}}</b> <b class="text-white btn btn-primary btn-sm" v-if='bet.selection==="Wala"'>{{bet.selection}}</b> </td>
                          <td class="text-center"> <button @click.prevent='switchw(index)' v-if='bet.selection==="Meron"' class="btn btn-outline-dark btn-sm">
                          <b> Change</b>
                        </button>
                        <button class="btn btn-outline-dark btn-sm" @click.prevent='switchm(index)' v-if='bet.selection==="Wala"'><b> Change<span class="glyphicon glyphicon-refresh"></span></b></button>
                      </td>
                      <!-- <td>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content" style="border:none !important;">
                ...
                <div class="modal-footer justify-content-center">
                  <pagination :data="bets" :show-disabled=true :limit='5' @pagination-change-page="geteventbetss">
