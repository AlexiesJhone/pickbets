        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-5">
            ...
            <div class="card" v-if="select" style="background-color: transparent;">
              <a class="float-right btn btn-sm btn-danger"  @click.prevent='goback' style="margin-bottom:0.5rem" v-if="!rebet"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Go Back to Startingfights</a>
              ...
              <div class="card-body" style="padding: 0.25rem;padding-top:0; background-color: white"><center>
                ...
                <p class="h6">Bet Amount : <b class="text-success">{{Number(fight.amount).toLocaleString()}}</b></p>
              </center>
                      ...
                      <tbody class="" style="width:100%">
                        <tr v-for='(bet,index) in selected' :index="index">
                          ...
                          <td class="text-center">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="defaultCheck1" v-model="bets.b1.selection1">
                              <label class="form-check-label text-danger font-weight-bold" v-if="bets.b1.selection1">
                                M
                              </label>
                            </div>
                          </td>
