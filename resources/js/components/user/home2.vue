      ...
      methods:{
        ...
        created() {
          ...
          .listen('eventlistener',(event)=>{
            ...
            if (event.events.control==='Last Call' && this.events.id===event.events.id && this.select===event.events.startingfight ) {
              ...
              else if (event.events.control==="Open" && this.events.id===event.events.id && this.select===event.events.startingfight ){
                this.control='Open';
                // this.getevents();
