                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body" id='printMe'>
                    <div class="card" v-for="t in receipt">
                      ...
                      <b>Bet :</b> <a v-if="fight.pick==2">{{t.selection}}</a> <a v-if="fight.pick==20">{{t.selection}}</a> <br>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body" id='printMe2'>
                    <div class="card" v-for="t in receipt">
                      ...
                      <b>Bet :</b> <a v-if="fight.pick==2||t.turn==2">{{t.bet}}</a> <a v-if="fight.pick==20||t.turn==20">{{t.bet}}</a> <br>
                    <b>Paalala</b> : Ang napanalunang Ticket <br>
                    ay dito lamang pwede i claim sa <br>
                      arenang ito, at panatilihing malinis ang ticket <br>
                      at wag iwawala. at sa araw lamang ng event <br> pwede iwithdraw ang payout.<br>
              ...
              <div class="card-body" style="padding: 0.25rem;padding-top:0; background-color: white"><center>
                ...
                <p v-if="fight.pick==2 && !rebet && possible" class="text-success">Possible Payout for {{possiblepayout2}} :
                  <a v-for="t in possible" v-if="possible">
                    <a v-if="possiblepayout2==='MM'" class="text-success font-weight-bold">{{Number(t.mm).toLocaleString()}} per 100</a>
                    <a v-if="possiblepayout2==='Mw'" class="text-success font-weight-bold">{{Number(t.mw).toLocaleString()}} per 100</a>
                    <a v-if="possiblepayout2==='MD'" class="text-success font-weight-bold">{{Number(t.md).toLocaleString()}} per 100</a>
                    <a v-if="possiblepayout2==='wM'" class="text-success font-weight-bold">{{Number(t.wm).toLocaleString()}} per 100</a>
                    ...
                    <table class="table table-sm  table-striped table-borderless table-hover">
                      <thead class="thead-dark">
                        <tr>
                          ...
                          <th class="text-center text-danger btn-title-button" style="cursor: pointer;" @click.prevent='allmeron' title="Select all meron"  v-title data-placement="top"><a >Meron</a></th>
                          <th class="text-center text-info btn-title-button" style="cursor: pointer;" @click.prevent='allwala' title="Select all wala" v-title data-placement="top"><a >Wala</a></th>
...
<script>
    ...
    export default {
      ...
      computed: {
          ...
          //   this.currentbet = this.currentbet+val.bet;
