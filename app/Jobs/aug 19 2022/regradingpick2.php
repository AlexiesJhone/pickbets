    ...
    public function handle()
    {
      ...
      $control = control::first();
        ...
        if ($getevent->currentfight >= $lastnumber) {
          event(new resultevent('alex ang pogi mo '.$startingfight->id.' '.$getbet,$isangcancel,$dalawangcancel,$tatlongcancel,'cancelcount ay '.$checkforcancel,'last number ay '.$lastnumber,'fught number ay'.$fightnumber,''));
