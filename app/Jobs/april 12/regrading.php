...
class regrading implements ShouldQueue
{
    ...
    public function handle()
    {
      ...
      ->join('expertbet as c', 'a.expertbet_id', '=', 'c.id')
      ->update(['c.wins' =>DB::raw('wins + 1')]);
      event(new resultevent($checkforcancel,$startingfight->startingfight,$lastnumber,'alexx','alex1',$bagongresult,$fightnumber,$lastnumbernocancel));
    }
    ...
    elseif($checkforcancel>=2&&$fightnumber!=$lastnumber) {
      // return $isangcancel;
        DB::table('selection as a')
      ->where('a.fightnumber', '=', $fightnumber)->whereIn('a.event_id', $a)->where('a.selection', '=', $lumangresult)
      ->join('expertbet as c', 'a.expertbet_id', '=', 'c.id')
      ...
      ->join('expertbet as c', 'a.expertbet_id', '=', 'c.id')
      ->update(['c.wins' =>DB::raw('wins + 1')]);
      event(new resultevent($checkforcancel,$startingfight->startingfight,$lastnumber,'alex1','alex1',$bagongresult,$fightnumber,$lastnumbernocancel));
