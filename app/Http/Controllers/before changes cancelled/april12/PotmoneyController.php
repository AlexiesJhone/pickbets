...
class PotmoneyController extends Controller
{
  ...
  public function open(Request $req)
  {
    ...
    if ($checker->wins===$control->pick) {
      ...
      // }
      $finalhighestpercentage = $control->jackpot/$counthighest;
      foreach ($gethighest as $key) {
        ...
        $createlogs->message = $checkuser->name.',Recieved '.$finalhighestpercentage;
        $createlogs->save();
        }
      ...
      foreach ($getsecond as $key) {
        ...
        if ($checkuser2->role===3) {
          ...
          $createlogs->message = $checkuser2->name.',Recieved '.$finalsecondpercentage;
          $createlogs->save();
        }
      ...
      foreach ($getthird as $key) {
        ...
        if ($checkuser3->role===3) {
          ...
          $createlogs->message = $checkuser3->name.',Recieved '.$finalthirdpercentage;
          $createlogs->save();
        }
      ...
      foreach ($getfourth as $key) {
        ...
        if ($checkuser4->role===3) {
          ...
          $createlogs->message = $checkuser4->name.',Recieved '.$finalfourthpercentage;
          $createlogs->save();
        }
      ...
      foreach ($getlowest0 as $key) {
        ...
        if ($checkuser5->role===3) {
          ...
          $createlogs->message = $checkuser5->name.',Recieved '.$finallowestpercentage0;
          $createlogs->save();
        }
      ...
      foreach ($getlowest1 as $key) {
        ...
        if ($checkuser6->role===3) {
          ...
          $createlogs->message = $checkuser6->name.',Recieved '.$finallowestpercentage1;
          $createlogs->save();
        }
      ...
      foreach ($getlowest2 as $key) {
        ...
        if ($checkuser7->role===3) {
          ...
          $createlogs->message = $checkuser7->name.',Recieved '.$finallowestpercentage2;
          $createlogs->save();
        }
      ...
      foreach ($getlowest3 as $key) {
        ...
        if ($checkuser8->role===3) {
          ...
          $createlogs->message = $checkuser8->name.',Recieved '.$finallowestpercentage3;
          $createlogs->save();
        }
    ...
    // PAG HINDI JACKPOT ANG NANALO.
      ...
      foreach ($gethighest as $key) {
        ...
        if ($checkuser9->role===3) {
          ...
          $createlogs->message = $checkuser9->name.',Recieved '.$finalhighestpercentage;
          $createlogs->save();
        }
        $insertresult->result = $finalhighestpercentage;
        $insertresult->save();
      ...
      foreach ($getsecond as $key) {
        ...
        if ($checkuser10->role===3) {
          ...
          $createlogs->message = $checkuser10->name.',Recieved '.$finalsecondpercentage;
          $createlogs->save();
        }
        $insertresult->result = $finalsecondpercentage;
        $insertresult->save();
      ...
      foreach ($getthird as $key) {
        ...
        if ($checkuser11->role===3) {
          ...
          $createlogs->message = $checkuser11->name.',Recieved '.$finalthirdpercentage;
          $createlogs->save();
        }
        $insertresult->result = $finalthirdpercentage;
        $insertresult->save();
      ...
      foreach ($getfourth as $key) {
        ...
        if ($checkuser12->role===3) {
          ...
          $createlogs->message = $checkuser12->name.',Recieved '.$finalfourthpercentage;
          $createlogs->save();
        }
        $insertresult->result = $finalfourthpercentage;
        $insertresult->save();
      ...
      foreach ($getlowest0 as $key) {
        ...
        if ($checkuser13->role===3) {
          ...
          $createlogs->message = $checkuser13->name.',Recieved '.$finallowestpercentage0;
          $createlogs->save();
        }
        $insertresult->result = $finallowestpercentage0;
        $insertresult->save();
      ...
      foreach ($getlowest1 as $key) {
        ...
        if ($checkuser14->role===3) {
          ...
          $createlogs->message = $checkuser14->name.',Recieved '.$finallowestpercentage1;
          $createlogs->save();
        }
        $insertresult->result = $finallowestpercentage1;
        $insertresult->save();
      ...
      foreach ($getlowest2 as $key) {
        ...
        if ($checkuser15->role===3) {
          ...
          $createlogs->message = $checkuser15->name.',Recieved '.$finallowestpercentage2;
          $createlogs->save();
        }
        $insertresult->result = $finallowestpercentage2;
        $insertresult->save();
      ...
      foreach ($getlowest3 as $key) {
        ...
        if ($checkuser16->role===3) {
          ...
          $createlogs->message = $checkuser16->name.',Recieved '.$finallowestpercentage3;
          $createlogs->save();
        }
        $insertresult->result = $finallowestpercentage3;
        $insertresult->save();
